      ...
      <div className="container cta-content" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 180, display: "flex", alignItems: "center" }}>
            <Link to="/" style={{ color: "#fff", textDecoration: "none", fontWeight: 700, fontSize: "1.25rem", display: "flex", alignItems: "center" }}>
              <span className="logo-dots" style={{ marginRight: 8 }}>
                <span className="logo-dot logo-dot-1 animate-pulse"></span>
                <span className="logo-dot logo-dot-2 animate-pulse" style={{ animationDelay: "0.2s" }}></span>
                <span className="logo-dot logo-dot-3 animate-pulse" style={{ animationDelay: "0.4s" }}></span>
              </span>
              Check<span style={{ color: "#7000FF" }}>Point</span>
            </Link>
          </div>
          ...
          <div style={{ flex: 2, minWidth: 250, display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ display: "flex", gap: "1.5rem", marginBottom: 8 }}>
              <button style={{ background: "none", border: "none", color: "#fff", cursor: "pointer" }} onClick={() => openDialog("privacy")}>Privacy Policy</button>
              <button style={{ background: "none", border: "none", color: "#fff", cursor: "pointer" }} onClick={() => openDialog("tnc")}>Terms of Service</button>
            </div>
            <button className="btn btn-outline px-6 py-3" style={{ marginTop: 8 }} onClick={() => openDialog("privacy")}>Learn More About Us</button>
          </div>

          {/* Right: Contact */}
          <div style={{ flex: 1, minWidth: 180, textAlign: "right", display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
            <a href="mailto:contact@example.com" style={{ color: "#A885FF", marginBottom: 4 }}>Email: contact@example.com</a>
            <a href="tel:+1234567890" style={{ color: "#A885FF" }}>Call: +1234567890</a>
          </div>
        </div>
      </div>
