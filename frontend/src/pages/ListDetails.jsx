            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setEditForm({
                        ...
                        tags: Array.isArray(data.list.tags) ? data.list.tags.join(", ") : data.list.tags || "",
            ...
            <div className="min-h-screen bg-black text-white">
                ...
                <div className="flex items-center justify-center min-h-[60vh]">
                    <div className="text-center">
                        ...
                        <p className="text-gray-400 mb-4">The list you're looking for doesn't exist.</p>
            ...
            <div className="relative">
                {list.coverImage && (
                    <div className="absolute inset-0 h-96">
                        <img src={list.coverImage || "/placeholder.svg"} alt={list.title} className="w-full h-full object-cover" />
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <div className="flex items-center gap-1 text-gray-400">
                                        ...
                                        <span className="text-sm capitalize">{list.whoCanView}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-6 text-sm text-gray-400 mb-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>
                                            Created by{" "}
                                            <span className="text-white font-medium">{list.createdBy?.userName || list.createdBy}</span>
                                        </span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                ...
                                <p className="text-gray-300 text-lg leading-relaxed mb-6">{list.description}</p>

                                {/* Tags */}
                                {list.tags && list.tags.length > 0 && (
                                    <div className="flex flex-wrap gap-2 mb-6">
                                        {(Array.isArray(list.tags) ? list.tags : list.tags.split(",")).map((tag, idx) => (
                                            <span
                                                key={idx}
                    ...
                    <div className="text-center py-16">
                        <div className="bg-gray-900 rounded-xl p-8 max-w-md mx-auto border border-gray-800">
                            ...
                            <p className="text-gray-500 mb-4">
                                This list is empty. {isOwner ? "Add some games to get started!" : "Check back later for updates."}
                            </p>
                            {isOwner && (
                                <button
                                    onClick={() => {
                        ...
                        <form onSubmit={handleEditSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setEditForm({ ...editForm, whoCanView: e.target.value })}
                                    className="input w-full"
                                >
                ...
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <button onClick={() => setShowAddGamesModal(false)} className="text-gray-400 hover:text-white">
                                <X className="w-6 h-6" />
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-6 max-h-96 overflow-y-auto">
                            {filteredGames?.map((game) => (
                                <div
                                    key={game._id}
                                    className={`relative cursor-pointer rounded-lg overflow-hidden border-2 transition-all ${selectedGames.includes(game._id)
                                        ? "border-purple-500 bg-purple-500/20"
                                        : "border-gray-700 hover:border-gray-600"
                                        }`}
                                    onClick={() => {
                                        if (selectedGames.includes(game._id)) {
                                            setSelectedGames(selectedGames.filter((id) => id !== game._id))
                                        } else {
                                ...
                                >
                                    ...
                                    />
                                    <div className="p-3">
                                        <h4 className="font-medium text-sm line-clamp-2">{game.title}</h4>
                                    </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button onClick={() => setShowAddGamesModal(false)} className="btn btn-outline">
                                    Cancel
                                </button>
                            </div>
                        </div>
